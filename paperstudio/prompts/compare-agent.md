...
- `THIS_ANALYSIS_DIR`: analysis directory of the paper that called `/paperstudio:compare` (the focal paper).
...
```html
<!-- generated: <runtime-iso8601-utc> by compare-agent (paperstudio v<plugin-version>) -->
```
