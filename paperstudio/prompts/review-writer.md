...
```html
<!-- generated: <original-ts> by reviewer-synthesizer; edited <runtime-iso8601-utc> by review-writer (paperstudio v<plugin-version>) -->
```

If no provenance comment exists at the top of `review.md` (legacy file), prepend a fresh one:

```html
<!-- generated: <runtime-iso8601-utc> by review-writer (paperstudio v<plugin-version>) -->
```
