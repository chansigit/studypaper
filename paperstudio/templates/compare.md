<!-- generated: <runtime-timestamp> by compare-agent (paperstudio v<plugin-version>) -->
---
this_paper: <slug>
...
> Generated by `/paperstudio:compare` from `paperstudio`. Both papers must already have an `analysis/` directory under `~/claude-papers/papers/<slug>/`.
