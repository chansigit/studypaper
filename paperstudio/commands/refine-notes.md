...
# /paperstudio:refine-notes

Invokes the `refine-notes` skill from the `paperstudio` plugin.

Usage:
- `/paperstudio:refine-notes xhs` — refine the Xiaohongshu rendering of the most recently studied paper.
- `/paperstudio:refine-notes wechat` — refine the WeChat rendering.
- `/paperstudio:refine-notes xhs --paper attention-is-all-you-need` — target a specific paper.
...
Pre-requisites: `/paperstudio:study` must have produced `notes/source.md` and `notes/<platform>.md` already.
