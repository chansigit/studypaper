...
@test "README documents /paperstudio:review-round" {
  grep -qF '/paperstudio:review-round' README.md
}
...
@test "README documents /paperstudio:refine-notes" {
  grep -qF '/paperstudio:refine-notes' README.md
}

@test "README documents /paperstudio:retitle" {
  grep -qF '/paperstudio:retitle' README.md
}

@test "README documents /paperstudio:reselect-figures" {
  grep -qF '/paperstudio:reselect-figures' README.md
}
...
@test "README documents /paperstudio:deep-dive" {
  grep -qF '/paperstudio:deep-dive' README.md
}

@test "README documents /paperstudio:compare" {
  grep -qF '/paperstudio:compare' README.md
}

@test "README documents /paperstudio:add-prior-work" {
  grep -qF '/paperstudio:add-prior-work' README.md
}
...
@test "README documents /paperstudio:reproduce-check" {
  grep -qF '/paperstudio:reproduce-check' README.md
}
